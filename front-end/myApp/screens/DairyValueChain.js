...
//                 <Text style={styles.cell}>Cow Number: {item.cow_number}</Text>
//                 <Text style={styles.cell}>Cow Race: {item.cow_race}</Text>
//                 <Text style={styles.cell}>Artificial Insemination Date: {item.artificial_insemination_date}</Text>
//                 <Text style={styles.cell}>Artificial Insemination Triggered: {item.artificial_insemination_triggered}</Text>
//                 <Text style={styles.cell}>Return in Heat Control Date: {item.return_in_heat_control_date}</Text>
//                 <Text style={styles.cell}>Pregnancy Detection Date: {item.pregnancy_detection_date}</Text>
//                 <Text style={styles.cell}>Drying Off Date: {item.drying_off_date}</Text>
//                 <Text style={styles.cell}>Calving and Delivery Date: {item.calving_and_delivery_date}</Text>
//               </View>
//             )}
//           />
//         </View>
